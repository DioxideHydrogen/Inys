...
def main():
    try:
        while True:
            ...
            results = service.users().messages().list(userId='me',labelIds = ['INBOX', 'UNREAD'], maxResults=5, q="category:primary").execute() # q="category:primary" or labelIds = ['INBOX', 'UNREAD', "CATEGORY_PERSONAL"]
